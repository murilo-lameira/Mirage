...
> 🔗 **Índice Mestre do Projeto:** [[00 - MOCs & Índices/00 - MOC Principal|00 - MOC Principal]]
...
> 🔗 Veja também: [[20 - Arquitetura do Sistema/Cromossomo & Genes|Cromossomo & Genes]]
...
> 🔗 Veja também: [[20 - Arquitetura do Sistema/Função de Fitness|Função de Fitness]]
...
> 🔗 Veja também: [[20 - Arquitetura do Sistema/Simulação & Física de Esquiva|Simulação & Física de Esquiva]] | [[10 - Referências Científicas/Ref - Lee (KIOTS)|Ref - Lee (KIOTS)]]
...
- **Slide 3 — Fundamentação Científica: Qualidade-Diversidade:** [[10 - Referências Científicas/Ref - Kirk & Scirea (Map-Elites)|Ref - Kirk & Scirea (Map-Elites)]].
- **Slide 4 — Cinemática da Esquiva Preditiva:** [[10 - Referências Científicas/Ref - Lee (KIOTS)|Ref - Lee (KIOTS)]] e Steering Behaviors de Reynolds.
- **Slide 5 — O Genoma do NPC e o Orçamento Global (Point-Buy):** [[20 - Arquitetura do Sistema/Cromossomo & Genes|Cromossomo & Genes]].
- **Slide 6 — Função de Fitness Multi-Objetivo:** [[20 - Arquitetura do Sistema/Função de Fitness|Função de Fitness]].
- **Slide 7 — A Arena 2D de Simulação Física:** Radar periférico e detecção de CPA.
- **Slide 8 — Parametrização e Operadores do AG:** [[30 - Parâmetros & Dificuldades/Parametrização Geral do GA|Parametrização Geral do GA]].
- **Slide 9 — Escalonamento de Dificuldade (Fácil, Médio, Difícil):** [[30 - Parâmetros & Dificuldades/Configuração de Dificuldade|Configuração de Dificuldade]].
- **Slide 10 — Critério de Parada e Estabilidade de Bhandari:** [[30 - Parâmetros & Dificuldades/Critério de Parada e Convergência|Critério de Parada e Convergência]].
- **Slide 11 — Estudo de Caso: O Problema da Convergência Prematura:** [[40 - Experimentos & Resultados/O Problema da Convergencia Prematura|O Problema da Convergencia Prematura]].
- **Slide 12 — Automação Paralela e Resultados Experimentais (30 Testes):** [[40 - Experimentos & Resultados/Execução Paralela & Análise Comparativa|Execução Paralela & Análise Comparativa]].
- **Slide 13 — Gráficos Comparativos de Convergência do Octave:** [[40 - Experimentos & Resultados/Diário de Testes|Diário de Testes]].
...
> 🔗 Veja o roteiro completo em: [[Markdown/50 - Gestão do Seminário/Roteiro de Apresentação (15 min)|Roteiro de Apresentação (15 min)]]  
> 🔗 Divisão de responsabilidades em: [[Markdown/50 - Gestão do Seminário/Divisão de Tarefas & Apresentadores|Divisão de Tarefas & Apresentadores]]
...
- [[10 - Referências Científicas/Ref - Lee (KIOTS)|Ref - Lee (KIOTS)]]
- [[10 - Referências Científicas/Ref - Kirk & Scirea (Map-Elites)|Ref - Kirk & Scirea (Map-Elites)]]
- [[20 - Arquitetura do Sistema/Cromossomo & Genes|Cromossomo & Genes]]
- [[20 - Arquitetura do Sistema/Função de Fitness|Função de Fitness]]
- [[20 - Arquitetura do Sistema/Simulação & Física de Esquiva|Simulação & Física de Esquiva]]
- [[30 - Parâmetros & Dificuldades/Parametrização Geral do GA|Parametrização Geral do GA]]
- [[30 - Parâmetros & Dificuldades/Configuração de Dificuldade|Configuração de Dificuldade]]
- [[30 - Parâmetros & Dificuldades/Critério de Parada e Convergência|Critério de Parada e Convergência]]
- [[40 - Experimentos & Resultados/Diário de Testes|Diário de Testes]]
- [[40 - Experimentos & Resultados/O Problema da Convergencia Prematura|O Problema da Convergencia Prematura]]
- [[40 - Experimentos & Resultados/Execução Paralela & Análise Comparativa|Execução Paralela & Análise Comparativa]]
- [[Markdown/50 - Gestão do Seminário/Divisão de Tarefas & Apresentadores|Divisão de Tarefas & Apresentadores]]
- [[Markdown/50 - Gestão do Seminário/Roteiro de Apresentação (15 min)|Roteiro de Apresentação (15 min)]]
